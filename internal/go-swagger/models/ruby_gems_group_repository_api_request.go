...
func (m *RubyGemsGroupRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RubyGemsGroupRepositoryAPIRequest) validateGroup(formats strfmt.Registry) error {
...
func (m *RubyGemsGroupRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *RubyGemsGroupRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *RubyGemsGroupRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *RubyGemsGroupRepositoryAPIRequest) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RubyGemsGroupRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RubyGemsGroupRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res RubyGemsGroupRepositoryAPIRequest
