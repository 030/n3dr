...
func (m *GolangGroupRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GolangGroupRepositoryAPIRequest) validateGroup(formats strfmt.Registry) error {
...
func (m *GolangGroupRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *GolangGroupRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *GolangGroupRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *GolangGroupRepositoryAPIRequest) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GolangGroupRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GolangGroupRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res GolangGroupRepositoryAPIRequest
