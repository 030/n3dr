...
func (m *HelmHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HelmHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res HelmHostedRepositoryAPIRequest
