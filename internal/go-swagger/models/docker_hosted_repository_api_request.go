...
func (m *DockerHostedRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DockerHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) validateDocker(formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) contextValidateDocker(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res DockerHostedRepositoryAPIRequest
