...
var readLdapServerXoTypeAuthSchemePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		readLdapServerXoTypeAuthSchemePropEnum = append(readLdapServerXoTypeAuthSchemePropEnum, v)
	}
}
...
// prop value enum
func (m *ReadLdapServerXo) validateAuthSchemeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, readLdapServerXoTypeAuthSchemePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ReadLdapServerXo) validateAuthScheme(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateConnectionRetryDelaySeconds(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateConnectionTimeoutSeconds(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateGroupIDAttribute(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateGroupMemberAttribute(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateGroupMemberFormat(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateGroupObjectClass(formats strfmt.Registry) error {
...
var readLdapServerXoTypeGroupTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		readLdapServerXoTypeGroupTypePropEnum = append(readLdapServerXoTypeGroupTypePropEnum, v)
	}
}
...
// prop value enum
func (m *ReadLdapServerXo) validateGroupTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, readLdapServerXoTypeGroupTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ReadLdapServerXo) validateGroupType(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateHost(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateMaxIncidentsCount(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateName(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validatePort(formats strfmt.Registry) error {
...
var readLdapServerXoTypeProtocolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		readLdapServerXoTypeProtocolPropEnum = append(readLdapServerXoTypeProtocolPropEnum, v)
	}
}
...
// prop value enum
func (m *ReadLdapServerXo) validateProtocolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, readLdapServerXoTypeProtocolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ReadLdapServerXo) validateProtocol(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateSearchBase(formats strfmt.Registry) error {
...
func (m *ReadLdapServerXo) validateUserMemberOfAttribute(formats strfmt.Registry) error {
