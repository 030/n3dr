...
func (m *RHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res RHostedRepositoryAPIRequest
