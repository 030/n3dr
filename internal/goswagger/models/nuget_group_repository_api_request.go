...
func (m *NugetGroupRepositoryAPIRequest) validateGroup(formats strfmt.Registry) error {
...
func (m *NugetGroupRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *NugetGroupRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *NugetGroupRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *NugetGroupRepositoryAPIRequest) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NugetGroupRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NugetGroupRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res NugetGroupRepositoryAPIRequest
