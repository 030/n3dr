...
func (o *UpdatePrivilege3BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/repository-content-selector/{privilegeId}][%d] updatePrivilege3BadRequest ", 400)
}
...
func (o *UpdatePrivilege3Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/repository-content-selector/{privilegeId}][%d] updatePrivilege3Forbidden ", 403)
}
...
func (o *UpdatePrivilege3NotFound) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/repository-content-selector/{privilegeId}][%d] updatePrivilege3NotFound ", 404)
}
