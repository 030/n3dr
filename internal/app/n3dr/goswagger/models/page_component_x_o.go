...
func (m *PageComponentXO) validateItems(formats strfmt.Registry) error {
...
func (m *PageComponentXO) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
