...
func (m *SimpleAPIHostedRepository) validateCleanup(formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) validateComponent(formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) validateName(formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) validateOnline(formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) validateStorage(formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SimpleAPIHostedRepository) UnmarshalBinary(b []byte) error {
	var res SimpleAPIHostedRepository
