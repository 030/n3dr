...
func (m *BowerHostedRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BowerHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BowerHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res BowerHostedRepositoryAPIRequest
