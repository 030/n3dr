...
func (m *DockerHostedAPIRepository) validateCleanup(formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) validateComponent(formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) validateDocker(formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) validateName(formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) validateOnline(formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) validateStorage(formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) contextValidateDocker(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DockerHostedAPIRepository) UnmarshalBinary(b []byte) error {
	var res DockerHostedAPIRepository
