...
func (o *UpdatePrivilegeBadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/wildcard/{privilegeId}][%d] updatePrivilegeBadRequest ", 400)
}
...
func (o *UpdatePrivilegeForbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/wildcard/{privilegeId}][%d] updatePrivilegeForbidden ", 403)
}
...
func (o *UpdatePrivilegeNotFound) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/wildcard/{privilegeId}][%d] updatePrivilegeNotFound ", 404)
}
