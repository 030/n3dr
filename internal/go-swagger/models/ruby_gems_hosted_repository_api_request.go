...
func (m *RubyGemsHostedRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RubyGemsHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RubyGemsHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res RubyGemsHostedRepositoryAPIRequest
