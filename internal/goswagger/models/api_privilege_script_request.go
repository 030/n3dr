...
var apiPrivilegeScriptRequestActionsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		apiPrivilegeScriptRequestActionsItemsEnum = append(apiPrivilegeScriptRequestActionsItemsEnum, v)
	}
}

func (m *APIPrivilegeScriptRequest) validateActionsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, apiPrivilegeScriptRequestActionsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *APIPrivilegeScriptRequest) validateActions(formats strfmt.Registry) error {
...
func (m *APIPrivilegeScriptRequest) validateName(formats strfmt.Registry) error {
...
func (m *APIPrivilegeScriptRequest) UnmarshalBinary(b []byte) error {
	var res APIPrivilegeScriptRequest
