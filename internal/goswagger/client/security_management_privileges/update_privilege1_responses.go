...
func (o *UpdatePrivilege1BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/application/{privilegeId}][%d] updatePrivilege1BadRequest ", 400)
}
...
func (o *UpdatePrivilege1Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/application/{privilegeId}][%d] updatePrivilege1Forbidden ", 403)
}
...
func (o *UpdatePrivilege1NotFound) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/application/{privilegeId}][%d] updatePrivilege1NotFound ", 404)
}
