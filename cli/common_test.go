...
// 	n.Pass = ""
// 	n.validate()
// 	jsonResp := n.requestJSON("incorrectUrl")
// 	assert.EqualError(t, jsonResp.err, "Get \"incorrectUrl\": GET incorrectUrl giving up after 1 attempt(s): Get \"incorrectUrl\": unsupported protocol scheme \"\"")
// 	n.User = "admin"
// 	n.Pass = "admin123"
// }
