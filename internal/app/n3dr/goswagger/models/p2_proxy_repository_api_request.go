...
func (m *P2ProxyRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateHTTPClient(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateNegativeCache(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateProxy(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateReplication(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) contextValidateHTTPClient(ctx context.Context, formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) contextValidateNegativeCache(ctx context.Context, formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) contextValidateProxy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) contextValidateReplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *P2ProxyRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res P2ProxyRepositoryAPIRequest
