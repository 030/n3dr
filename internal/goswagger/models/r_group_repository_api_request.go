...
func (m *RGroupRepositoryAPIRequest) validateGroup(formats strfmt.Registry) error {
...
func (m *RGroupRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *RGroupRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *RGroupRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *RGroupRepositoryAPIRequest) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RGroupRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RGroupRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res RGroupRepositoryAPIRequest
