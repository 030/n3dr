...
func (m *NpmHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NpmHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res NpmHostedRepositoryAPIRequest
