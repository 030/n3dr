...
func (m *BowerGroupRepositoryAPIRequest) validateGroup(formats strfmt.Registry) error {
...
func (m *BowerGroupRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *BowerGroupRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *BowerGroupRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *BowerGroupRepositoryAPIRequest) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BowerGroupRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BowerGroupRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res BowerGroupRepositoryAPIRequest
