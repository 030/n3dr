...
func (m *RawHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) validateRaw(formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) contextValidateRaw(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RawHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res RawHostedRepositoryAPIRequest
