...
func (m *YumHostedRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) validateComponent(formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) validateYum(formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) contextValidateYum(ctx context.Context, formats strfmt.Registry) error {
...
func (m *YumHostedRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res YumHostedRepositoryAPIRequest
